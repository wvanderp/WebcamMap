                    ...
                    <div className="row">
                        <div className="col-sm-8 col-md-7 py-4">
                            ...
                            <p className="text-muted">
                                ...
                                {' '}
                                <a
                                    href={`https://www.openstreetmap.org/note/new#map=${location.zoom}/${location.coordinates[0]}/${location.coordinates[1]}`}
                                >
                                    OpenStreetMap
                                </a>
                                {', '}
                        ...
                        <div className="col-sm-4 offset-md-1 py-4">
                            ...
                            <ul className="list-unstyled">
                                ...
                                <li>
                                    <a
                                        href={
                                            `https://www.openstreetmap.org/#map=${location.zoom}/${location.coordinates[0]}/${location.coordinates[1]}`
                                        }
                                        className="text-white"
                                    >
                                        <img
